    ...
    <table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%">
        ...
        @foreach ($syllabuses as $syllabus)
            <tr>
                ...
                <td>
                    <a href="{{ asset('public/public/backend/files/syllabus/'.$syllabus->file) }}" class="btn btn-info" download ><i class="mdi mdi-cloud-download mr-1"></i> <span>{{ translate('download') }}</span></a>
                </td>
                <td>
